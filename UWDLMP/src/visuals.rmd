...
g <- ggplot(graph, aes(x=delivery_month, y=perc_total, color=race_group)) +
  ...
  geom_point(aes(size = total, alpha = 0.5, text=paste('Delivery month:', format(delivery_month, '%Y-%m'),
...
g <- ggplot(graph, aes(x=race_group, y=value, fill=age_group, text= paste('Total number of mothers tested:', total,
